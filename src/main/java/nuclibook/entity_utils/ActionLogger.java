...
public class ActionLogger {
    ...
    public static final int ATTEMPT_VIEW_STAFF = 56;
    public static final int ATTEMPT_UPDATE_STAFF = 57;
    public static final int ATTEMPT_DELETE_STAFF = 58;
    public static final int CREATE_STAFF_ABSENCE = 59;
    public static final int VIEW_STAFF_ABSENCE = 60;
    public static final int UPDATE_STAFF_ABSENCE = 61;
    public static final int DELETE_STAFF_ABSENCE = 62;
    public static final int ATTEMPT_CREATE_STAFF_ABSENCE = 63;
    public static final int ATTEMPT_VIEW_STAFF_ABSENCE = 64;
    public static final int ATTEMPT_UPDATE_STAFF_ABSENCE = 65;
    public static final int ATTEMPT_DELETE_STAFF_ABSENCE = 66;
    public static final int CREATE_STAFF_AVAILABILITY = 67;
    public static final int VIEW_STAFF_AVAILABILITY = 68;
    public static final int UPDATE_STAFF_AVAILABILITY = 69;
    public static final int DELETE_STAFF_AVAILABILITY = 70;
    public static final int ATTEMPT_CREATE_STAFF_AVAILABILITY = 71;
    public static final int ATTEMPT_VIEW_STAFF_AVAILABILITY = 72;
    public static final int ATTEMPT_UPDATE_STAFF_AVAILABILITY = 73;
    public static final int ATTEMPT_DELETE_STAFF_AVAILABILITY = 74;
    public static final int VIEW_BOOKING_CALENDAR = 75;
    public static final int CREATE_BOOKING = 76;
    public static final int VIEW_BOOKING = 77;
    public static final int UPDATE_BOOKING = 78;
    public static final int DELETE_BOOKING = 79;
    public static final int ATTEMPT_VIEW_BOOKING_CALENDAR = 80;
    public static final int ATTEMPT_CREATE_BOOKING = 81;
    public static final int ATTEMPT_VIEW_BOOKING = 82;
    public static final int ATTEMPT_UPDATE_BOOKING = 83;
    public static final int ATTEMPT_DELETE_BOOKING = 84;
    public static final int LOG_IN = 85;
    public static final int ATTEMPT_LOG_IN_PASSWORD = 86;
    public static final int ATTEMPT_LOG_IN_STAFF_ID = 87;
    public static final int ATTEMPT_LOG_IN_STAFF_ID_DISABLED = 88;
    public static final int LOG_OUT = 89;
    public static final int ATTEMPT_LOG_OUT = 90;
    public static final int UPDATE_STAFF_PASSWORD = 91;
    public static final int ATTEMPT_UPDATE_STAFF_PASSWORD = 91;
