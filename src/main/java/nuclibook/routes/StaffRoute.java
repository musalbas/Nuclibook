...
/**
 * The class presents the rendered template of the staff.html page with data on it to the user if he has a permission to view the page.
 */
public class StaffRoute extends DefaultRoute {
    /**
     * Handles user's request to view staff.
     *
