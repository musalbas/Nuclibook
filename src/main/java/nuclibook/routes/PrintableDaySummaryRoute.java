...
public class PrintableDaySummaryRoute extends DefaultRoute {
	...
	public Object handle(Request request, Response response) throws Exception {
        ...
        renderer.setTemplateFile("printable-day-summary.html");
        ...
        renderer.setField("date-today", today.toString("dd-MM-YYYY"));
