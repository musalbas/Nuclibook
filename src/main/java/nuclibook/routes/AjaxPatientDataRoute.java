...
/**
 * This route provides data on patients in a JSON format and supports ordering and searching.
 */
public class AjaxPatientDataRoute extends DefaultRoute {
	...
	/**
	 * Creates an instance of this route with the relevant mode
	 * @param mode 0 for edit buttons, 1 for select buttons
	 */
	...
	/**
	 * Handles the request for patient data
