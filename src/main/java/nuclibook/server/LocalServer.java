	...
	public static void main(String... args) {
		...
		Spark.before((request, response) -> {
			...
			if (SecurityUtils.checkLoggedIn(session)
					...
					&& (!path.startsWith("/profile") && !(path.startsWith("/entity-update") && request.queryParams("entity-type") != null && request.queryParams("entity-type").equals("staff-password-change")))) {
