...
public class Booking {
    ...
    public Booking() {//Empty constructor for ORMLite
    }

    public Booking(Patient patient, Therapy therapy, Camera camera, Date start, Date end, String status, String notes) {
